...
class MeuServidor(BaseHTTPRequestHandler):
    def do_GET(self):
        caminho_arquivo = os.path.join(os.path.dirname(__file__), 'form007.html') # mudar o nome do arquivo no caminho para reaproveitar este servidor http em outros exercícios
